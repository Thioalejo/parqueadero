...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table class="nav-justified">
        ...
        <tr>
            <td colspan="2">
                <asp:GridView ID="GridView1" runat="server" Width="984px" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" CellPadding="10" ForeColor="Black" GridLines="Vertical">
